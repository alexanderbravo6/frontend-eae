...
function ResultadoInstitucionalTab({ ciclo }) {
    return (
        <>
                        ...
                        <Tabs placement={"start"} aria-label="Options">
                            <Tab key="pie_1" title="COMPRENSIÓN LECTORA">
                                <section className=' flex flex-wrap gap-5'>
                                    <NivelDesempenioInstitucionalCard prueba={"PRUEBA DE COMPRENSIÓN LECTORA (PRIMER CICLO)"} />

                                </section>
                            </Tab>
                            <Tab key="pie_2" title="HABILIDADES MATEMÁTICAS">
                                <section className=' flex flex-wrap gap-5'>
                                    <NivelDesempenioInstitucionalCard prueba={"PRUEBA DE HABILIDADES MATEMÁTICAS (PRIMER CICLO)"} />
