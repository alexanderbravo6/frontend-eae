...
function RegistrarDescripcionForm({ onClose, idPrueba }) {


    const { registrarDescripcion } = usePruebaService()
    ...
    const form = handleSubmit(async (data) => {
        ...
        try {
            const response = await registrarDescripcion(request)
...
export default RegistrarDescripcionForm
