...
function TemplateBaseInput({ label, name,
    ...props
}) {
    return (
        <>
            <label htmlhtmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Título de Enunciado  </label>
...
export default TemplateBaseInput